        ...
        <div className='shop'>
            <div className="container">
                <div className="row series-image-list ">
                 ...
                 <p class="text-center"><div class="p-3 mb-2 bg-warning text-dark borderoLP table-void text-white"><h1>Daily Quests rewards</h1></div></p>
...
<ul class="list-group">
  ...
  <li class="list-group-item">5x Akamur Coupon</li>
  <li class="list-group-item">5x Magical Camel Parchment Scroll</li></ul>
  <br></br>
 ...
 <div class="col-xs-4 col-md-2">
  ...
  <div class="col-xs-4 col-md-2">
  <img src="asset/prestige81/quest2.png" class="img-responsive" alt="Logo"/>
  </div>
  <div class="col-xs-4 col-md-2">
...
<div className='borderoLP'>
                     ...
                     <ul class="list-group">
                       ...
                       <li class="list-group-item">5x Flame Giant`s Heart </li>
                       <li class="list-group-item">50.000 Reputation </li>
                       <li class="list-group-item">Cellon (Level 10) x5 </li></ul>
                       <br></br>
                       <div class="col-xs-12 col-md-6">
                      <div class="row">
                       <div class="col-xs-4 col-md-2">
                       ...
                       <div class="col-xs-4 col-md-2">
                       <img src="asset/prestige81/quest9.png" class="img-responsive" alt="Logo"/>
                       </div>  
                       <div class="col-xs-4 col-md-2">
