                    ...
                    <div className="card">
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                ...
                                <p>1x Volcano Specialist Card</p>
                                <p>1x Fire Cannoneer Specialist Card</p>
                                <p>1x Gladiator Specialist Card</p>
                                <p>2x Large Lump of Gold</p>
                                <p>1x Grail's Pattern</p>
                                <p>1x Rarify Item</p>
                    ...
                    <div className="card">
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                ...
                                <p>50x Angel's Feathers</p>
                                <p>50x Seed of Power</p>
                                <p>1x Scout Specialists Card</p>
                                <p>1x Tide Lord Specialists Card</p>
                                <p>1x Battle Monk Specialists Card</p>
                                <p>1x Mystic Arts Specialists</p>
                                <p>1x Rarify Item</p>
                                <p>1x Broken Key</p>
                    ...
                    <div className="card">
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                ...
                                <p>50x Angel's Feathers</p>
                                <p>50x Seed of Power</p>
                                <p>3x Lower SP Protection Scroll</p>
                                <p>3x High SP Protection Scroll</p>
                                <p>2x Golden Equipment Protection Scroll</p>
                                <p>3x Perfection</p>
                                <p>2x Raid Ticket</p>
                                <p>1x Rarify Item</p>
                                <p>1x Upgrade Stone</p>
                        ...
                        <div className="flip-card-inner">
                            <div className="flip-card-front">
                                ...
                                <div className="card-body ">
                                    ...
                                    <p className="card-text ">
                                        ...
                                        You can have Sp7 and Sp8(Sp3 for Martial). You can have Rarify itemin (for Badge
                                        rare) .
                            ...
                            <div className="flip-card-back ">
                                ...
                                <div className="toomuchtext">
                                    ...
                                    <p>1x Archmage Specialist Card</p>
                                    <p>1x Avenging Angel Specialists Card</p>
                                    <p>1x Renegade Specialists Card</p>
                                    <p>1x Seer Specialists Card</p>
                                    <p>1x Demon Hunter Specialists Card</p>
                                    <p>1x Death Reaper Specialists Card</p>
                                    <p>1x Demon Warrior Card</p>
                                    <p>1x Master Wolf Specialists Card</p>
                                    <p>3x Large Lump of Gold</p>
                                    <p>2x Raid Tickets</p>
                                    <p>1x Rarify Item</p>
                                    <p>
                                        1x Soul of Innocence</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flip-card-front">
                                ...
                                <div className="card-body ">
                                    ...
                                    <p className="card-text ">
                                        ...
                                        You can craft 92-93 equipment and resistance
                    ...
                    <div className="card">
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                ...
                                <p>x70 Full Moon Crystal</p>
                                <p>x70 Angel's Feather</p>
                                <p>
                        ...
                        <div className="card ">
                            <div className="flip-card-inner">
                                ...
                                <div className="flip-card-back ">
                                    ...
                                    <p>Donkey Hat</p>
                                    <p>Hippo Hat</p>
                                    <p>Big Ear Hairband</p>
                                    <p>Old Gentelman's Hat</p>
                                    <p>Plunger Hat</p>
                                    <p>Head Gear</p>
                                    <p>x100 Full Moon Crystal</p>
                                    <p>x100 Angel's Feather</p>
                                    <p>x100 Cella Powder</p>
                                ...
                                <div className="flip-card-front">
                                    ...
                                    <div className="card-body ">
                                        ...
                                        <p className="card-text ">
                                            ...
                                            You can obtain C25 equipment materials, Resistance, fairies
                                ...
                                <div className="flip-card-back">
                                    ...
                                    <div className="toomuchtext">
                                        ...
                                        <p>
                                            1x Zenas (Light)</p>
                                        <p>1x Zenas (Shadow)</p>
                                        <p>1x Zenas' Divine Ring</p>
                                        <p>1x Zenas' Necklace</p>
                                        <p>1x Zenas' Ring</p>
                                        <p>1x Zenas' Bracelet</p>
                                        <p>1x Sealed Heavenly Gloves</p>
                                        <p>
                                            1x Sealed Heavenly Shoes</p>
                                        <p>1x Moth Powder</p>
                                        <p>1x Random Amulet Box (1x)</p>
                                        <p>1x Upgrade Item</p>
                                        <p>1x Soul of Zenas</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flip-card-inner">
                                ...
                                <div className="flip-card-back">
                                    ...
                                    <div className="toomuchtext">
                                        ...
                                        <p>1x Erenia's Necklace</p>
                                        <p>1x Erenia's Bracelet</p>
                                        <p>1x Erenia's Ring</p>
                                        <p>1x Sealed Hellord Gloves</p>
                                        <p>1x Sealed Hellord Shoes
                                        </p>
                                        <p>1x The Elementary Book of Adventurer</p>
                                        <p>1x Upgrade Item</p>
                                        <p>1x Soul of Erenia</p>
                                    </div>
                                    ...
                                    <div className="flip-card-front">
                                        ...
                                        <div className="card-body ">
                                            ...
                                            <p className="card-text ">
                                                ...
                                                You can get Cellon and Laurena accessories,Rune
